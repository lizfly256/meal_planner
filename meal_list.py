recipes = [
    ...
    {
        'name': 'Creamy Garlic Rigatoni Chicken Sausage',
    ...
    {
        'name': 'Creamy Tomato and Italian Sausage Penne',
    ...
    {
        'name': 'Creamy Tomato  and Pork Sausage Linguine',
    ...
    {
        'name': 'Saucy Cherry-Balsamic Pork Chops',
    ...
    {
        'name': 'Lasagna Style Beef and pork Bolognese Gemelli',
    ...
    {
        'name': 'Creamy Pork Sausage and Couscous Soup',
    ...
    {
        'name': 'Creamy Tomato and Chicken Sausage Cavatappi',
    ...
    {
        'name': 'Pulled Chicken Salsa Verde Taquitos',
    ...
    {
        'name': 'Classic Chicken Cutlet Piccata',
    ...
    {
        'name': 'Chile-Lime Sliced Steak Rice Bowl',
    ...
    {
        'name': 'Italian Pork Sausage and Pepper Subs',
    ...
    {
        'name': 'Corn and Steak Strip Risotto',
    ...
    {
        'name': 'Hearty Chicken Sausage & Kale Soup',
    ...
    {
        'name': 'Cheesy Smokehouse Beef Hash',
    ...
    {
        'name': 'Italian Pork Sausage Marinara Subs',
    ...
    {
        'name': "Southwest Queso Mac 'N' Cheese",
    ...
    {
        'name': 'Creamy Cajun-Style Italian Sausage Gemelli',
    ...
    {
        'name': 'Italian Sausage Fettuccine Arrabbiata',
    ...
    {
        'name': 'Tex-Mex Marinated Pork Tacos',
